...
export const MOCK_SESSION_PROFILES: Record<AppMode, ActiveProfile> = {
  ...
  institution: {
    ...
    institutionName: "Hospital Josina Machel",
  ...
  admin: {
    mode: "admin",
    role: "Director de Tecnologias de Saúde e Inovação",
    institutionName: "Ministério da Saúde (MINSA)",
    departmentName: "Gabinete de Tecnologia de Informação e Comunicação (GTIC)",
...
export const MOCK_INSTITUTIONAL_INBOX: Message[] = [
  ...
  },
  {
    ...
    details: {
      ...
      body: "Ilustre Conservador de Registo Civil,\n\nSolicito por este meio a reemissão e autenticação digital em formato eletrónico Dr.IA da cópia integral de assento de casamento civil consensual, lavrado sob o Livro de Matrimónios do ano de 2022 desta Conservatória de Registo Civil de Belas, sob titularidade de Edlasio Galhardo.\n\nA certidão destina-se a fins puramente administrativos internos e requerimento de crédito de habitação bonificada para jovem casal.\n\nEfectuei o pagamento legal emolumentar e remeti comprovativos bancários em anexo.\n\nSubmeto com devoção,\nEdlasio Galhardo\nBI: 009874562LA041",
...
export const MOCK_CERTIFICATES: MockCertificateEntity[] = [
  ...
  },
  {
    id: "CERT-EDL-01",
    holder: "Edlasio Galhardo",
    institution: "DRIA - Assinatura Qualificada",
...
export const MOCK_AI_ASSISTANTS: MockAIAssistantConfig[] = [
  {
    ...
    greetingMessage: "Olá Edlasio! Sou o seu Guia de Voz Oficial do DR.IA de Angola. Em que posso auxiliá-lo hoje hoje?",
    voicePitch: 1.0,
    voiceSpeed: 0.95
  },
  {
...
export const MOCK_AUDIT_LOGS: MockAuditLogEntity[] = [
  { id: '1', action: 'Plataforma DR.IA de Angola Inicializada', user: 'SYSTEM', timestamp: '14/06/2026 08:00', type: 'info' },
...
export function generateMockProtocol(id: string | number, type: string, inst: string): DigitalProtocol {
  return {
    internalId: `DRIA-PRT-${id}`,
    protocolNumber: `DRIA-2026-PT-${Math.floor(100000 + Math.random() * 900000)}`,
    ...
    qrCodeUrl: "https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=DrIA-ProtocoloAuth-14-06-2026",
    digitalSignature: "MIIEuwYJKoZIhvcNAQcCoIIErDCCBKgCAQExDzANBglghkgBZQMEAgEFADCBvAYJKoZIhvcNAQcBoIG8BIG5",
    digitalSeal: "HSM-SEAL-DRIA-AO-2026",
