...
function extractTranslatableStrings(): string[] {
  ...
  const extraUI = [
    // Navigation & Tabs
    "Painel", "Triagem", "Hospitais", "Histórico", "Socorros", "Conta", "IA",
    ...
    // UI Labels
    "Destaques & Novidades", "Triagem IA", "Hospitais", 
    ...
    "ID Digital", "Cidadão Verificado", "Profissional de Saúde Verificado",
    ...
    "Segurança Dr.IA", "Ver Correspondências",
    ...
    "Infraestrutura Oficial do Ministério da Saúde",
    "Cidadão", "Hospital", "MINSA",
    "Login", "Email Institucional", "Email de Acesso", "Senha de Acesso",
    "Entrar com BI e Senha",
    
    // Document Content
    "Triagem Pendente", "Resultado de Exames",
    ...
    "Expira", "Relatório Clínico", "Prescrição Médica",
    ...
    "Assinado com Sucesso Dr.IA v4.1",
    "Identificador Oficial", "Nº da Factura",
    "Referência Clínica", "ID Nacional de Utente",
