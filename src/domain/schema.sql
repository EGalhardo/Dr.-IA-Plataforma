...
VALUES ('e8f96112-be24-4fa0-b88d-6be6281735cb', 'DRIA-2026-PT-901183', 'AGT', '2026-06-14', '08:30:15', 'Dr. Francisco Manuel', 'Notificação e Expediente', 'Tributário / IPU', 'Autenticado no Barramento do Estado', 'Alta', 'MIIEuwYJKoZIhvcNAQcCoIIErDCCBKgCAQExDzANBglghkgBZQMEAgEFADCBv', 'Lei Geral das Tecnologias de Informação (Nº 2/14)');
...
VALUES 
('ai-gove-voice', 'Guia de Voz Dr.IA', 'https://i.postimg.cc/J73QvnGv/Foto-Edlasio.png', 'Voz Inclusiva', 'Olá Edlasio! Em que posso ajudar no Dr.IA?', 1.0, 0.95),
