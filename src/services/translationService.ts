...
const STATIC_TRANSLATE_MAP: Record<string, Record<LanguageCode, string>> = {
  ...
  "Comunicações Dr.IA": { pt: "Comunicações Dr.IA", um: "Olovikanda Vyofeka", ki: "Mikanda ya Thangu", kk: "Nsamu mia nzo", ch: "Chisinde chipema", ng: "Mikando ya kunda", kw: "Ombila yapongoka", nh: "Okanda kofuka", fi: "Mamboti mambote" },
  "Carteira de Saúde": { pt: "Carteira de Saúde", um: "Okanda Kosola", ki: "Mikanda-Upange", kk: "Nzo-Kinkulu", ch: "Mukanda-Asola", ng: "Mikando-Lelev", kw: "Iilonga-Ayehe", nh: "Okanda-Okutula", fi: "Bisalu-Bitunu" },
  ...
  "Profissional de Saúde": { pt: "Profissional de Saúde", um: "Profissional Dr.IA Oluku", ki: "Profissional Dr.IA Kixilu", kk: "Profissional Dr.IA Lulendo", ch: "Profissional Dr.IA Ipupolo", ng: "Profissional Dr.IA Kinoneno", kw: "Profissional Dr.IA Eendunge", nh: "Profissional Dr.IA Epupolo", fi: "Profissional Dr.IA Nzila-Lula" },
  ...
  "Segurança Dr.IA": { pt: "Segurança Dr.IA", um: "Kotela DRIA", ki: "Kixilu DRIA", kk: "Lulendo DRIA", ch: "Ipupolo DRIA", ng: "Vihhande DRIA", kw: "Eendunge DRIA", nh: "Epupolo DRIA", fi: "Nzila-Lula DRIA" },
  ...
  "O seu assistente de triagem clínica": { pt: "O seu assistente de triagem clínica", um: "Olonjango vyene vyokali", ki: "Soneka ya thangu yakali", kk: "Nzila yakali ya nzo", ch: "Chisinde chonene chipema", ng: "Mikando yayile yoshe", kw: "Ombila ipe yapongoka", nh: "Okanda ohali kofuka", fi: "Bumboti mukali mbote" },
  "Cidadão": { pt: "Cidadão", um: "Cidadaô", ki: "Miji", kk: "Nkangu", ch: "Atu", ng: "Vakwetu", kw: "Aanitu", nh: "Ovanthu", fi: "Batu" },
  "Hospital": { pt: "Hospital", um: "Ohongele", ki: "Vihandela", kk: "Nkenda", ch: "Mwenya", ng: "Vihandeka", kw: "Oshilongo", nh: "Omilandu", fi: "Mutinu" },
  "Instituição": { pt: "Instituição", um: "Ocingonjo", ki: "Vihandela", kk: "Nkenda", ch: "Mwenya", ng: "Vihandeka", kw: "Oshilongo", nh: "Omilandu", fi: "Mutinu" },
  "MINSA": { pt: "MINSA", um: "Ondunge-Copi", ki: "Nkuluntu", kk: "Mbuta", ch: "Mwata", ng: "Mwene", kw: "Omuhona", nh: "Omuhonga", fi: "Mutinu" },
  ...
  "Dr.IA": { pt: "Dr.IA", um: "Okanda Kosola", ki: "Mikanda-Upange", kk: "Nzo-Kinkulu", ch: "Mukanda-Asola", ng: "Mikando-Lelev", kw: "Iilonga-Ayehe", nh: "Okanda-Okutula", fi: "Bisalu-Bitunu" },
