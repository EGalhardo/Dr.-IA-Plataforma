...
const INITIAL_MOCK_SESSIONS: VideoSessionExtended[] = [
  {
    ...
    associatedProtocol: 'DRIA-2026-61849',
    associatedMessageId: 1,
    status: 'disponivel',
    hostBi: 'HOSP-DRIA-0220',
    hostName: 'Dr. Valeriano Mendes (Dr.IA)',
  ...
  },
  {
    ...
    associatedProtocol: 'DRIA-2026-92850',
    associatedMessageId: 2,
    status: 'concluida',
    hostBi: 'HOSP-DRIA-0034',
    hostName: 'Superintendente Carla Neto (Dr.IA)',
    guestBi: '005204192LA048',
    guestName: 'Edlasio Galhardo',
  ...
  },
  {
    ...
    associatedProtocol: 'DRIA-2026-10294',
    status: 'agendada',
  ...
  },
  {
    ...
    associatedProtocol: 'DRIA-2026-77341',
    status: 'em_curso',
    hostBi: 'INST-MF-0089',
...
const INITIAL_MOCK_EVENTS: VideoSessionEvent[] = [
  {
    ...
    eventType: 'criada',
    bi: 'HOSP-DRIA-0034',
    userName: 'Superintendente Carla Neto (Dr.IA)',
