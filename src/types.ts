...
export const SENSITIVITY_LEVELS: Record<'Público' | 'Privado' | 'Sensível' | 'Restrito' | 'Ultra Restrito', SensitivityConfig> = {
  ...
  'Privado': {
    ...
    encryption: 'Cifragem AES-256 com chaves padrão do sistema Dr.IA.',
...
export const PRIORITY_CONFIGS: Record<'Normal' | 'Importante' | 'Urgente' | 'Crítico', PriorityConfig> = {
  ...
  'Crítico': {
    ...
    dotColor: 'bg-red-600',
    defaultHours: 24,
    consequence: 'Notificação crítica do sistema Dr.IA — resposta obrigatória em 24h.',
...
export interface Correspondence {
  ...
  institution: 'MINSA' | 'Hospital' | 'Centro de Saúde' | string;
