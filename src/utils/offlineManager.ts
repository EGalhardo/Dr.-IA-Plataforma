...
export class OfflineManager {
  ...
  public static triggerFallback(channel: 'SMS' | 'USSD' | 'PUSH', targetAction: string): { message: string; protocol: string } {
    ...
    if (channel === 'SMS') {
      message = `[Dr.IA - SMS Fallback]: O seu pedido de '${targetAction}' foi enfileirado localmente devido a indisponibilidade de internet. Um SMS redundante de validação foi gerado para transmissão ao gateway da Dr.IA via Protocolo ${trackingProtocol}.`;
