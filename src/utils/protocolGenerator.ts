...
export function ensureProtocolOnMessage(msg: Message): Message {
  ...
  if (!details) {
    details = {
      subject: subj,
      body: `Prezado(a) utente,\n\nInformamos que foi registada uma nova movimentação clínica associada à sua identidade através do barramento integrado da plataforma DR.IA Angola.\n\nEsta comunicação refere-se ao assunto: "${subj}" expedida por ${orgName}.\n\nOs serviços de saúde integrados e tecnologias inteligentes continuam a reforçar a proximidade dos cidadãos aos cuidados médicos do Estado angolano com toda a segurança, confidencialidade e validade garantida por lei.\n\nCaso necessite de apresentar alguma dúvida ou solicitar agendamentos, utilize os botões de resposta formal ou fale diretamente com o nosso assistente inteligente de voz e texto.\n\nAtenciosamente,\nDireção Geral de Saúde de Angola`,
